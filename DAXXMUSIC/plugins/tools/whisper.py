    ...
    if len(data.split()) < 2:
        mm = [
            InlineQueryResultArticle(
                ...
                thumb_url="https://telegra.ph/file/02adc1d91efa881e2cb95.jpg",
...
async def in_help():
    answers = [
        InlineQueryResultArticle(
            title="💒 Whisper",
            description=f"@Shalinixmusicxbot [USERNAME | ID] [TEXT]",
            input_message_content=InputTextMessageContent(f"**📍Usage:**\n\n@Shalinixmusicxbot (Target Username or ID) (Your Message).\n\n**Example:**\n@Shalinixmusicxbot @username I Wanna 💞 You"),
            thumb_url="https://telegra.ph/file/02adc1d91efa881e2cb95.jpg",
            reply_markup=switch_btn
        )
    ]
